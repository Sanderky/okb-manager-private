...
import { createScheduleMap } from '../lib/createMap';
import { ScheduleApi } from '@/entities/shedule';
import { daysToRanges, formatWeeksString } from '@/shared/lib/date';
...
export const ScheduleManager = () => {
  ...
  const {
    ...
    queryFn: () => VacationApi.getVacationListForMonths(months),
  ...
  const {
    ...
    queryFn: () =>
      ScheduleApi.getScheduleListForDateRange(
