...
import { type Construction, ConstructionApi } from '@/entities/construction';
...
export function ConstructionShowPage() {
  ...
  const {
    ...
    queryFn: () =>
      EmployeeApi.getEmployeesByScheduledConstruction(
        [constructionId!],
        dayjs().toDate()
      ),
    enabled: !!constructionId,
  ...
  const updateNoteMutation = useMutation({
    mutationFn: (newNote: string) =>
      ConstructionApi.updateConstruction(constructionId!, { note: newNote }),
    onSuccess: () => {
