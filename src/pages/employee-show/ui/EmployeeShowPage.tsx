...
import { EmployeeApi, fetchAlertsSettings} from '@/entities/employee';
...
export function EmployeeShowPage() {
  ...
  const {
    ...
    queryFn: () => VacationApi.getUpcomingVacationsForEmployee(employeeId!),
    enabled: !!employeeId,
  });
  ...
  const updateNoteMutation = useMutation({
    mutationFn: (newNote: string) =>
      EmployeeApi.updateEmployee(employeeId!, { note: newNote }),
    onSuccess: () => {
