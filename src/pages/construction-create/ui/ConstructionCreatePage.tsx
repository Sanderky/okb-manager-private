...
import { ConstructionApi, shouldBeInactive, type Construction } from '@/entities/construction';
import { ConstructionForm, validate, type ConstructionFormState, type FormFieldValue } from '@/features/constructions';
...
export function ConstructionCreatePage() {
  ...
  const createMutation = useMutation({
    mutationFn: (newConstruction: Partial<Construction>) =>
      ConstructionApi.createConstruction(newConstruction as Construction),
